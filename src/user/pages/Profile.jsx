  ...
  return (
    ...
    <Header/>
      ...
      <div style={{width:'230px',height:'230px',borderRadius:'50%',marginTop:'-130px',marginLeft:'70px'}} className="bg-white p-3">
        <img style={{width:'200px',height:'200px',borderRadius:'50%'}} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLn2vN-qAufnhM8t2e4OkZ6-m3Md6_Gk9B7g&s" alt="user" />
      </div>
      ...
      <p className="text-justify md:px-20 px-5 my-5">This is your personal space where you can manage your account, explore your reading activity, track your orders, and save books you love. Whether you're building a wishlist, discovering new arrivals, or reviewing your recent purchases, this page keeps everything organized and easy to access. Your reading journey continues here — enjoy exploring, discovering, and collecting stories that inspire you. ✨</p>  
         <div className="md:px-40">
          <div className="flex justify-center items-center my-8 font-medium text-lg">
            <p onClick={()=>setCurrentTab(1)} className={currentTab==1?'p-4 border-grey-200 border-l border-t border-r rounded cursor-pointer':'p-4 border-grey-200 border-b rounded cursor-pointer'}>Upload book</p>
            <p onClick={()=>setCurrentTab(2)} className={currentTab==2?'p-4 border-grey-200 border-l border-t border-r rounded cursor-pointer':'p-4 border-grey-200 border-b rounded cursor-pointer'}>Upload Book status</p>
            <p onClick={()=>setCurrentTab(3)} className={currentTab==3?'p-4 border-grey-200 border-l border-t border-r rounded cursor-pointer':'p-4 border-grey-200 border-b rounded cursor-pointer'}>Purchase History</p>
          </div>
